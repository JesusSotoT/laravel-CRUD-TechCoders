    ...
    <div>
        <div class="max-w-6xl mx-auto py-10 sm:px-6 lg:px-8">
            <div class="block mb-8">
                ...
                <a href="{{ route('exportPDF') }}" class="bg-blue-800 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Export Users to PDF</a>
                <a href="{{ route('exportXLS') }}" class="bg-purple-800 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded">Export Users to XLS</a>
